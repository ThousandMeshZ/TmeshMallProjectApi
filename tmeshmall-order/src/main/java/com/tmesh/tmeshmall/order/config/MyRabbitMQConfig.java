...
/**
 * 创建队列，交换机，延时队列，绑定关系 的 configuration
 * 1.Broker 中的 Queue、Exchange、Binding 不存在的情况下，会自动创建（在 RabbitMQ），不会重复创建覆盖
...
public class MyRabbitMQConfig {
    ...
    public Queue orderDelayQueue() {
        ...
        arguments.put("x-message-ttl", 5 * 60 * 1000); // 消息过期时间 5分钟
