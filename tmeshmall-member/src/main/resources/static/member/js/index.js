...
$(".nav_ul .li ol li a").hover(function(){
  $(this).css({"background":"#F3F3F3","color":"#E43953"})
},function(){
  $(this).css({"background":"#fff","color":"#000"})
})

$("#orderTop li").click(function () {
  for (var i = 0; i < $(this).siblings().length; i++) {
    var sib = $(this).siblings()[i];
    var tName = sib.tagName.toLowerCase();
    if (tName == "li") {
      $(sib).removeAttr("style","");
    }
  }
  $(this).css({"color": "#E4393C", "text-decoration": "underline", "font-weight": 600})
})
