            ...
            if(ctgnums){
                ...
                $.each(ctgnumArray,function (i,ctg1Id) {
                    ...
                    $.each(ctg2list,function (i,ctg2) {
                        var cata2link=$("<a href=\"http://search.tmesh.cn/list.html?catalog3Id="+ctg2.id+"\" style= 'color: #111;' class='aaa'>"+ctg2.name+"  ></a>");
                        ...
                        $.each(ctg3List,function (i,ctg3) {
                            var cata3link = $("<a href=\"http://search.tmesh.cn/list.html?catalog3Id="+ctg3.id+"\" style=\"color: #999;\">" + ctg3.name + "</a>");
                            li.append(cata3link);
