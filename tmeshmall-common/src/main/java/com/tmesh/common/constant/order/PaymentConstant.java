...
public class PaymentConstant {
    ...
    public enum PayBusinessDetailType {
        ALI_ORDER(201, 201001, "订单支付", "/payed/ali/notify", "http://member.tmesh.cn/memberOrder.html"),
        ALI_ORDER_HK(202, 201001, "订单支付", "/payed/ali/hk/notify", "http://member.tmesh.cn/memberOrder.html"),
        ;
