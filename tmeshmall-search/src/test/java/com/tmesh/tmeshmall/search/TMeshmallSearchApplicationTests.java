...
@SpringBootTest
public class TMeshmallSearchApplicationTests {
    ...
    public void indexData() throws IOException {
        ...
        //执行操作
        IndexResponse index = client.index(indexRequest, TMeshmallElasticSearchConfig.COMMON_OPTIONS);
